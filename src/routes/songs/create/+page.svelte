...
<form method="POST"
    ...
    <div class="flex flex-col w-3/4 p-5 mb-4">
        ...
        <input id="key" type="text" name="key" class="p-2 border rounded" in:fly={{ y: -30, duration: 400, delay: 100 }} />
        <label for="reflink" class="mb-1" in:fly={{ y: -30, duration: 400, delay: 150 }}>Referencia</label>
        <input id="reflink" type="text" name="reflink" class="p-2 border rounded" in:fly={{ y: -30, duration: 400, delay: 150 }} />
    </div>
