...
-- performance_user_set_status trigger per the toque's approval mode.
...
-- pings the applicant. AFTER trigger; recipient is never the actor. See
-- migrations/20260826_signup_notifications.sql.
